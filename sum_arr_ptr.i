...
# 35 "c:\\mingw\\include\\malloc.h" 3
       
# 36 "c:\\mingw\\include\\malloc.h" 3
...
# 42 "c:\\mingw\\include\\malloc.h" 2 3
# 52 "c:\\mingw\\include\\malloc.h" 3
typedef
struct _heapinfo
{
...
# 80 "c:\\mingw\\include\\malloc.h" 3





 __attribute__((__cdecl__)) __attribute__((__nothrow__)) int _heapwalk (_HEAPINFO *);

 __attribute__((__cdecl__)) __attribute__((__nothrow__)) int _heapchk (void);
 __attribute__((__cdecl__)) __attribute__((__nothrow__)) int _heapmin (void);

 __attribute__((__cdecl__)) __attribute__((__nothrow__)) int _heapset (unsigned int);

 __attribute__((__cdecl__)) __attribute__((__nothrow__)) size_t _msize (void *);
 __attribute__((__cdecl__)) __attribute__((__nothrow__)) size_t _get_sbh_threshold (void);
 __attribute__((__cdecl__)) __attribute__((__nothrow__)) int _set_sbh_threshold (size_t);
 __attribute__((__cdecl__)) __attribute__((__nothrow__)) void *_expand (void *, size_t);





 __attribute__((__cdecl__)) __attribute__((__nothrow__)) int heapwalk (_HEAPINFO *);
# 142 "c:\\mingw\\include\\malloc.h" 3
...
# 170 "c:\\mingw\\include\\malloc.h" 3
__attribute__((__cdecl__)) __attribute__((__nothrow__)) __attribute__((__malloc__))
extern inline __attribute__((__gnu_inline__)) __attribute__((__always_inline__))
...
# 201 "c:\\mingw\\include\\malloc.h" 3
__attribute__((__cdecl__)) __attribute__((__nothrow__)) __attribute__((__malloc__))
extern inline __attribute__((__gnu_inline__)) __attribute__((__always_inline__))
